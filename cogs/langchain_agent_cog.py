...
class LangChainAgentCog(discord.Cog, name="LangChainAgentCog"):
    ...
    async def send_settings_text(self, ctx):
        ...
        embed = discord.Embed(
            title="LangChain Agent Settings",
            description="The current settings of the LangChain Agent.",
            color=0x00FF00,
        )
    ...
    async def help_command(self, ctx):
        ...
        await ctx.defer()
        embed = discord.Embed(
            title="LangChainAgent Help", description="The current commands", color=0xC730C7
        )
        embed.add_field(
            name="/search",
